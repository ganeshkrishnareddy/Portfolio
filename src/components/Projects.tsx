...
const ProjectCard: React.FC<ProjectProps> = ({
  ...
  return (
    <div
      className="relative bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-lg group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:scale-105"
    ...
    >
      ...
      <div className="p-4 sm:p-6">
        <h3 className="text-lg sm:text-xl font-bold text-slate-800 dark:text-white mb-2 sm:mb-3 line-clamp-2 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">{title}</h3>
        ...
        <div className="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4">
          {technologies.slice(0, 3).map((tech, i) => (
            <span
              key={i}
              className="px-2 sm:px-3 py-1 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs rounded-full hover:bg-teal-100 dark:hover:bg-teal-900/30 transition-colors"
            >
              {tech}
            </span>
          ))}
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <button
            ...
            className="flex-1 py-2 px-3 sm:px-4 bg-teal-600 text-white rounded-md flex items-center justify-center hover:bg-teal-700 transition-all duration-300 hover:scale-105 hover:shadow-lg"
          >
          ...
          {githubLink && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="py-2 px-3 sm:px-4 bg-slate-800 dark:bg-slate-700 text-white rounded-md flex items-center justify-center hover:bg-slate-900 dark:hover:bg-slate-600 transition-all duration-300 hover:scale-105 hover:shadow-lg sm:flex-initial sm:w-auto"
            >
